...
/*
**(alleles means the blood type of the person)**
- we have data structure here called person.
- person made from parameters:
    - parents: array of size 2, each element is a pointer to a person.
    - alleles: array of size 2, each element is a char.
*/
...
const int GENERATIONS = 3; // Number of generations
const int INDENT_LENGTH = 4; // Number of spaces to indent

person *create_family(int generations); // this is a function, that returns a type person and receives an integer.
                                        //
